...
static void _InitContext(GUI_CONTEXT* pContext) {
  ...
  #if GUI_WINSUPPORT
    pContext->hAWin    = WM_GetBackgroundWindow();
  #endif
...
int GUI_Init(void) {
  ...
  r = LCD_Init();
    ...
    WM_Init();
  #endif
/* Make sure touch support is always loaded in simulation */
  #if defined (WIN32) & GUI_SUPPORT_TOUCH & GUI_WINSUPPORT
    WM_pfHandleTouch = WM_HandleTouch;
  #endif
  return r;
}
