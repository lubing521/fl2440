...
#ifndef  GUI_H
#define  GUI_H
#define __EMWIN_GSC__   /* Allow "C" to find out that µC/GUI is used */
...
int GUI_TOUCH_GetState(GUI_TOUCH_tState *pState);

extern int GUI_TOUCH_yPhys, GUI_TOUCH_xPhys;
#define GUI_TOUCH_GetxPhys() GUI_TOUCH_xPhys
#define GUI_TOUCH_GetyPhys() GUI_TOUCH_yPhys
...
/**** Keyboard routines - required by some widgets ****/
int GUI_X_GetKey(void);
int GUI_X_WaitKey(void);
void GUI_X_StoreKey(int Key);
...
void GUI_X_Log1(const char *s, int p0);
void GUI_X_Log2(const char *s, int p0, int p1);
void GUI_X_Log3(const char *s, int p0, int p1, int p2);
void GUI_X_Log4(const char *s, int p0, int p1, int p2,int p3);
void GUI_X_Warn(const char *s);
void GUI_X_Warn1(const char *s, int p0);
void GUI_X_Warn2(const char *s, int p0, int p1);
void GUI_X_Warn3(const char *s, int p0, int p1, int p2);
void GUI_X_Warn4(const char *s, int p0, int p1, int p2, int p3);
void GUI_X_ErrorOut(const char *s);
void GUI_X_ErrorOut1(const char *s, int p0);
void GUI_X_ErrorOut2(const char *s, int p0, int p1);
void GUI_X_ErrorOut3(const char *s, int p0, int p1, int p2);
void GUI_X_ErrorOut4(const char *s, int p0, int p1, int p2, int p3);
...
#define GUI_DRAW_RLE4 &LCD_DrawBitmap_RLE4
#define GUI_DRAW_RLE8 &LCD_DrawBitmap_RLE8
