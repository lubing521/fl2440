...
/* Make sure the macros are actually defined */
  ...
  #define GUI_DEBUG_ERROROUT(s)              GUI_X_ErrorOut(s)
  #define GUI_DEBUG_ERROROUT1(s,p0)          GUI_X_ErrorOut1(s,p0)
  #define GUI_DEBUG_ERROROUT2(s,p0,p1)       GUI_X_ErrorOut2(s,p0,p1)
  #define GUI_DEBUG_ERROROUT3(s,p0,p1,p2)    GUI_X_ErrorOut3(s,p0,p1,p2)
  #define GUI_DEBUG_ERROROUT4(s,p0,p1,p2,p3) GUI_X_ErrorOut4(s,p0,p1,p2,p3)
#else
...
/* Make sure the macros are actually defined */
  ...
  #define GUI_DEBUG_WARN(s)              GUI_X_Warn(s)
  #define GUI_DEBUG_WARN1(s,p0)          GUI_X_Warn1(s,p0)
  #define GUI_DEBUG_WARN2(s,p0,p1)       GUI_X_Warn2(s,p0,p1)
  #define GUI_DEBUG_WARN3(s,p0,p1,p2)    GUI_X_Warn3(s,p0,p1,p2)
  #define GUI_DEBUG_WARN4(s,p0,p1,p2,p3) GUI_X_Warn4(s,p0,p1,p2,p3)
#else
...
/* Make sure the macros are actually defined */
  ...
  #define GUI_DEBUG_LOG(s)              GUI_X_Log(s)
  #define GUI_DEBUG_LOG1(s,p0)          GUI_X_Warn1(s,p0)
  #define GUI_DEBUG_LOG2(s,p0,p1)       GUI_X_Warn2(s,p0,p1)
  #define GUI_DEBUG_LOG3(s,p0,p1,p2)    GUI_X_Warn3(s,p0,p1,p2)
  #define GUI_DEBUG_LOG4(s,p0,p1,p2,p3) GUI_X_Warn4(s,p0,p1,p2,p3)
#else
